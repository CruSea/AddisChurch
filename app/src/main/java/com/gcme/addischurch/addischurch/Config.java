...
public class Config extends Application {
    ...
    public static final String APP_API_URL = "http://www.panacea-soft.com/citiesdirectory-demo/index.php";

    public static final String APP_IMAGES_URL = "http://www.panacea-soft.com/citiesdirectory-demo/uploads/";
