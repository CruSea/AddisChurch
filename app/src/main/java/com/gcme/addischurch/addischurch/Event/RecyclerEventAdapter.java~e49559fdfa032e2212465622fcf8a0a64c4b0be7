...
public class RecyclerEventAdapter extends RecyclerView.Adapter<RecyclerEventAdapter.MyViewHolder> {
    ...
    @Override
    public RecyclerEventAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View rootView = inflater.inflate(R.layout.eventitem_recyclerview, parent, false);
        return new RecyclerEventAdapter.MyViewHolder(rootView);
    }

    @Override
    public void onBindViewHolder(RecyclerEventAdapter.MyViewHolder holder, int position) {
